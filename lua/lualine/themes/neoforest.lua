...
return {
	normal = {
		a = { bg = palette.bg3[1], fg = palette.blue[1], gui = "bold" },
		b = { bg = palette.bg1[1], fg = palette.lightGrey[1] },
		c = { bg = palette.bg1[1], fg = palette.lightGrey[1] },
	},
	insert = {
		a = { bg = palette.bg3[1], fg = palette.lightGreen[1], gui = "bold" },
		b = { bg = palette.bg1[1], fg = palette.lightGrey[1] },
		c = { bg = palette.bg1[1], fg = palette.lightGrey[1] },
	},
	visual = {
		a = { bg = palette.bg3[1], fg = palette.purple[1], gui = "bold" },
		b = { bg = palette.bg1[1], fg = palette.lightGrey[1] },
		c = { bg = palette.bg1[1], fg = palette.lightGrey[1] },
	},
	replace = {
		a = { bg = palette.bg3[1], fg = palette.red[1], gui = "bold" },
		b = { bg = palette.bg1[1], fg = palette.lightGrey[1] },
		c = { bg = palette.bg1[1], fg = palette.lightGrey[1] },
	},
	command = {
		a = { bg = palette.bg3[1], fg = palette.yellow[1], gui = "bold" },
		b = { bg = palette.bg1[1], fg = palette.lightGrey[1] },
		c = { bg = palette.bg1[1], fg = palette.lightGrey[1] },
	},
	terminal = {
		a = { bg = palette.bg3[1], fg = palette.lightGrey[1], gui = "bold" },
		b = { bg = palette.bg1[1], fg = palette.lightGrey[1] },
		c = { bg = palette.bg1[1], fg = palette.lightGrey[1] },
	},
