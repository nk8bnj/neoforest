...
let g:neoforest_loaded_file_types = []

if !(exists('g:colors_name') && g:colors_name ==# 'neoforest' && s:configuration.better_performance)
  highlight clear
  if exists('syntax_on')
    syntax reset
  endif
...
if s:configuration.transparent_background >= 1
  call neoforest#highlight('Normal', s:palette.fg, s:palette.none)
  call neoforest#highlight('NormalNC', s:palette.fg, s:palette.none)
  call neoforest#highlight('Terminal', s:palette.fg, s:palette.none)
  if s:configuration.show_eob
    call neoforest#highlight('EndOfBuffer', s:palette.bg4, s:palette.none)
  else
    call neoforest#highlight('EndOfBuffer', s:palette.bg0, s:palette.none)
  endif
  if s:configuration.ui_contrast ==# 'low'
    call neoforest#highlight('FoldColumn', s:palette.bg5, s:palette.none)
  else
    call neoforest#highlight('FoldColumn', s:palette.grey0, s:palette.none)
  endif
  call neoforest#highlight('Folded', s:palette.grey1, s:palette.none)
  call neoforest#highlight('SignColumn', s:palette.fg, s:palette.none)
  call neoforest#highlight('ToolbarLine', s:palette.fg, s:palette.none)
else
  call neoforest#highlight('Normal', s:palette.lightGrey, s:palette.bg0)
  if s:configuration.dim_inactive_windows
    call neoforest#highlight('NormalNC', s:palette.lightGrey, s:palette.bg_dim)
  else
  ...
  call neoforest#highlight('Folded', s:palette.grey1, s:palette.bg1)
  call neoforest#highlight('ToolbarLine', s:palette.fg, s:palette.bg2)
  if s:configuration.sign_column_background ==# 'grey'
    call neoforest#highlight('SignColumn', s:palette.fg, s:palette.bg1)
    call neoforest#highlight('FoldColumn', s:palette.grey2, s:palette.bg1)
  else
    call neoforest#highlight('SignColumn', s:palette.fg, s:palette.none)
    if s:configuration.ui_contrast ==# 'low'
      call neoforest#highlight('FoldColumn', s:palette.bg5, s:palette.none)
...
call neoforest#highlight('IncSearch', s:palette.bg0, s:palette.red)
call neoforest#highlight('Search', s:palette.bg0, s:palette.green)
highlight! link CurSearch IncSearch
call neoforest#highlight('ColorColumn', s:palette.none, s:palette.bg1)
if s:configuration.ui_contrast ==# 'low'
  call neoforest#highlight('Conceal', s:palette.bg5, s:palette.none)
else
  call neoforest#highlight('Conceal', s:palette.grey0, s:palette.none)
endif
if s:configuration.cursor ==# 'auto'
  call neoforest#highlight('Cursor', s:palette.none, s:palette.none, 'reverse')
else
  call neoforest#highlight('Cursor', s:palette.bg0, s:palette[s:configuration.cursor])
endif
...
if &diff
  call neoforest#highlight('CursorLine', s:palette.none, s:palette.none, 'underline')
  call neoforest#highlight('CursorColumn', s:palette.none, s:palette.none, 'bold')
else
  call neoforest#highlight('CursorLine', s:palette.none, s:palette.bg1)
  call neoforest#highlight('CursorColumn', s:palette.none, s:palette.bg1)
endif
if s:configuration.ui_contrast ==# 'low'
  call neoforest#highlight('LineNr', s:palette.bg5, s:palette.none)
  if &diff
    call neoforest#highlight('CursorLineNr', s:palette.grey1, s:palette.none, 'underline')
  elseif (&relativenumber == 1 && &cursorline == 0) || s:configuration.sign_column_background ==# 'none'
    call neoforest#highlight('CursorLineNr', s:palette.grey1, s:palette.none)
  else
    call neoforest#highlight('CursorLineNr', s:palette.grey1, s:palette.bg1)
  endif
else
  call neoforest#highlight('LineNr', s:palette.grey0, s:palette.none)
  if &diff
    call neoforest#highlight('CursorLineNr', s:palette.grey2, s:palette.none, 'underline')
  elseif (&relativenumber == 1 && &cursorline == 0) || s:configuration.sign_column_background ==# 'none'
    call neoforest#highlight('CursorLineNr', s:palette.grey2, s:palette.none)
  else
    call neoforest#highlight('CursorLineNr', s:palette.grey2, s:palette.bg1)
  endif
endif
call neoforest#highlight('DiffAdd', s:palette.none, s:palette.bg_green)
call neoforest#highlight('DiffChange', s:palette.none, s:palette.bg_blue)
call neoforest#highlight('DiffDelete', s:palette.none, s:palette.bg_red)
call neoforest#highlight('DiffText', s:palette.bg0, s:palette.blue)
call neoforest#highlight('Directory', s:palette.mainAqua, s:palette.none)
call neoforest#highlight('ErrorMsg', s:palette.red, s:palette.none, 'bold,underline')
call neoforest#highlight('WarningMsg', s:palette.yellow, s:palette.none, 'bold')
call neoforest#highlight('ModeMsg', s:palette.fg, s:palette.none, 'bold')
call neoforest#highlight('MoreMsg', s:palette.yellow, s:palette.none, 'bold')
call neoforest#highlight('MatchParen', s:palette.none, s:palette.bg4)
call neoforest#highlight('NonText', s:palette.bg4, s:palette.none)
if has('nvim')
  call neoforest#highlight('Whitespace', s:palette.bg4, s:palette.none)
  call neoforest#highlight('SpecialKey', s:palette.yellow, s:palette.none)
else
  call neoforest#highlight('SpecialKey', s:palette.bg3, s:palette.none)
endif
call neoforest#highlight('Pmenu', s:palette.fg, s:palette.bg2)
call neoforest#highlight('PmenuSbar', s:palette.none, s:palette.bg2)
call neoforest#highlight('PmenuSel', s:palette.bg0, s:palette.statusline1)
call neoforest#highlight('PmenuKind', s:palette.green, s:palette.bg2)
call neoforest#highlight('PmenuExtra', s:palette.grey2, s:palette.bg2)
highlight! link WildMenu PmenuSel
call neoforest#highlight('PmenuThumb', s:palette.none, s:palette.grey0)
if s:configuration.float_style ==# 'dim'
  call neoforest#highlight('NormalFloat', s:palette.fg, s:palette.bg_dim)
  call neoforest#highlight('FloatBorder', s:palette.grey1, s:palette.bg_dim)
  call neoforest#highlight('FloatTitle', s:palette.fg, s:palette.bg_dim, 'bold')
else
  call neoforest#highlight('NormalFloat', s:palette.lightGrey, s:palette.bg0)
  call neoforest#highlight('FloatBorder', s:palette.grey1, s:palette.bg0)
  call neoforest#highlight('FloatTitle', s:palette.green, s:palette.bg0, 'bold')
endif
call neoforest#highlight('Question', s:palette.yellow, s:palette.none)
if s:configuration.spell_foreground ==# 'none'
  call neoforest#highlight('SpellBad', s:palette.none, s:palette.none, 'undercurl', s:palette.red)
  call neoforest#highlight('SpellCap', s:palette.none, s:palette.none, 'undercurl', s:palette.blue)
  call neoforest#highlight('SpellLocal', s:palette.none, s:palette.none, 'undercurl', s:palette.aqua)
  call neoforest#highlight('SpellRare', s:palette.none, s:palette.none, 'undercurl', s:palette.purple)
else
  call neoforest#highlight('SpellBad', s:palette.red, s:palette.none, 'undercurl', s:palette.red)
  call neoforest#highlight('SpellCap', s:palette.blue, s:palette.none, 'undercurl', s:palette.blue)
  call neoforest#highlight('SpellLocal', s:palette.aqua, s:palette.none, 'undercurl', s:palette.aqua)
  call neoforest#highlight('SpellRare', s:palette.purple, s:palette.none, 'undercurl', s:palette.purple)
endif
if s:configuration.transparent_background == 2
  call neoforest#highlight('StatusLine', s:palette.grey1, s:palette.none)
  call neoforest#highlight('StatusLineTerm', s:palette.grey1, s:palette.none)
  call neoforest#highlight('StatusLineNC', s:palette.grey0, s:palette.none)
  call neoforest#highlight('StatusLineTermNC', s:palette.grey0, s:palette.none)
  call neoforest#highlight('TabLine', s:palette.grey2, s:palette.bg3)
  call neoforest#highlight('TabLineFill', s:palette.grey1, s:palette.none)
  call neoforest#highlight('TabLineSel', s:palette.bg0, s:palette.statusline1)
  if has('nvim')
    call neoforest#highlight('WinBar', s:palette.grey1, s:palette.none, 'bold')
    call neoforest#highlight('WinBarNC', s:palette.grey0, s:palette.none)
  endif
else
  call neoforest#highlight('StatusLine', s:palette.grey1, s:palette.bg2)
  call neoforest#highlight('StatusLineTerm', s:palette.grey1, s:palette.bg1)
  call neoforest#highlight('StatusLineNC', s:palette.grey1, s:palette.bg1)
  call neoforest#highlight('StatusLineTermNC', s:palette.grey1, s:palette.bg0)
  call neoforest#highlight('TabLine', s:palette.grey2, s:palette.bg3)
  call neoforest#highlight('TabLineFill', s:palette.grey1, s:palette.bg1)
  call neoforest#highlight('TabLineSel', s:palette.bg0, s:palette.statusline1)
  if has('nvim')
    call neoforest#highlight('WinBar', s:palette.grey1, s:palette.bg2, 'bold')
    call neoforest#highlight('WinBarNC', s:palette.grey1, s:palette.bg1)
  endif
endif
if s:configuration.dim_inactive_windows
  call neoforest#highlight('VertSplit', s:palette.bg4, s:palette.bg_dim)
else
  call neoforest#highlight('VertSplit', s:palette.bg4, s:palette.none)
endif
highlight! link WinSeparator VertSplit
call neoforest#highlight('Visual', s:palette.none, s:palette.bg_visual)
call neoforest#highlight('VisualNOS', s:palette.none, s:palette.bg_visual)
call neoforest#highlight('QuickFixLine', s:palette.purple, s:palette.none, 'bold')
call neoforest#highlight('Debug', s:palette.orange, s:palette.none)
call neoforest#highlight('debugPC', s:palette.bg0, s:palette.green)
call neoforest#highlight('debugBreakpoint', s:palette.bg0, s:palette.red)
call neoforest#highlight('ToolbarButton', s:palette.bg0, s:palette.green)
if has('nvim')
  ...
  if s:configuration.diagnostic_text_highlight
    ...
    call neoforest#highlight('DiagnosticUnderlineInfo', s:palette.none, s:palette.bg_blue, 'undercurl', s:palette.blue)
    call neoforest#highlight('DiagnosticHint', s:palette.green, s:palette.bg_green)
    call neoforest#highlight('DiagnosticUnderlineHint', s:palette.none, s:palette.bg_green, 'undercurl', s:palette.green)
  else
    call neoforest#highlight('DiagnosticError', s:palette.red, s:palette.none)
    call neoforest#highlight('DiagnosticUnderlineError', s:palette.none, s:palette.none, 'undercurl', s:palette.red)
    call neoforest#highlight('DiagnosticWarn', s:palette.yellow, s:palette.none)
    call neoforest#highlight('DiagnosticUnderlineWarn', s:palette.none, s:palette.none, 'undercurl', s:palette.yellow)
    call neoforest#highlight('DiagnosticInfo', s:palette.blue, s:palette.none)
    call neoforest#highlight('DiagnosticUnderlineInfo', s:palette.none, s:palette.none, 'undercurl', s:palette.blue)
    call neoforest#highlight('DiagnosticHint', s:palette.green, s:palette.none)
    call neoforest#highlight('DiagnosticUnderlineHint', s:palette.none, s:palette.none, 'undercurl', s:palette.green)
  endif
...
" }}}
" Syntax: {{{
call neoforest#highlight('Boolean', s:palette.purple, s:palette.none)
call neoforest#highlight('Number', s:palette.purple, s:palette.none)
call neoforest#highlight('Float', s:palette.purple, s:palette.none)
if s:configuration.enable_italic
  call neoforest#highlight('PreProc', s:palette.purple, s:palette.none, 'italic')
  call neoforest#highlight('PreCondit', s:palette.purple, s:palette.none, 'italic')
  call neoforest#highlight('Include', s:palette.purple, s:palette.none, 'italic')
  call neoforest#highlight('Define', s:palette.purple, s:palette.none, 'italic')
  call neoforest#highlight('Conditional', s:palette.red, s:palette.none, 'italic')
  call neoforest#highlight('Repeat', s:palette.red, s:palette.none, 'italic')
  call neoforest#highlight('Keyword', s:palette.red, s:palette.none, 'italic')
  call neoforest#highlight('Typedef', s:palette.red, s:palette.none, 'italic')
  call neoforest#highlight('Exception', s:palette.red, s:palette.none, 'italic')
  call neoforest#highlight('Statement', s:palette.red, s:palette.none, 'italic')
else
  call neoforest#highlight('PreProc', s:palette.purple, s:palette.none)
  call neoforest#highlight('PreCondit', s:palette.purple, s:palette.none)
  call neoforest#highlight('Include', s:palette.purple, s:palette.none)
  call neoforest#highlight('Define', s:palette.purple, s:palette.none)
  call neoforest#highlight('Conditional', s:palette.red, s:palette.none)
  call neoforest#highlight('Repeat', s:palette.red, s:palette.none)
  call neoforest#highlight('Keyword', s:palette.red, s:palette.none)
  call neoforest#highlight('Typedef', s:palette.red, s:palette.none)
  call neoforest#highlight('Exception', s:palette.red, s:palette.none)
  call neoforest#highlight('Statement', s:palette.red, s:palette.none)
endif
call neoforest#highlight('Error', s:palette.red, s:palette.none)
call neoforest#highlight('StorageClass', s:palette.orange, s:palette.none)
call neoforest#highlight('Tag', s:palette.orange, s:palette.none)
call neoforest#highlight('Label', s:palette.orange, s:palette.none)
...
call neoforest#highlight('String', s:palette.green, s:palette.none)
call neoforest#highlight('Character', s:palette.green, s:palette.none)
call neoforest#highlight('Constant', s:palette.aqua, s:palette.none)
call neoforest#highlight('Macro', s:palette.aqua, s:palette.none)
call neoforest#highlight('Identifier', s:palette.blue, s:palette.none)
call neoforest#highlight('Todo', s:palette.bg0, s:palette.blue, 'bold')
if s:configuration.disable_italic_comment
  call neoforest#highlight('Comment', s:palette.grey1, s:palette.none)
  call neoforest#highlight('SpecialComment', s:palette.grey1, s:palette.none)
else
  call neoforest#highlight('Comment', s:palette.grey1, s:palette.none, 'italic')
  call neoforest#highlight('SpecialComment', s:palette.grey1, s:palette.none, 'italic')
endif
call neoforest#highlight('Delimiter', s:palette.fg, s:palette.none)
call neoforest#highlight('Ignore', s:palette.grey1, s:palette.none)
call neoforest#highlight('Underlined', s:palette.none, s:palette.none, 'underline')
" }}}
...
call neoforest#highlight('Yellow', s:palette.yellow, s:palette.none)
call neoforest#highlight('Green', s:palette.green, s:palette.none)
call neoforest#highlight('Aqua', s:palette.aqua, s:palette.none)
call neoforest#highlight('Blue', s:palette.blue, s:palette.none)
call neoforest#highlight('Purple', s:palette.purple, s:palette.none)
call neoforest#highlight('White', s:palette.white, s:palette.none)
call neoforest#highlight('ST2', s:palette.statusline2, s:palette.none)
if s:configuration.enable_italic
  call neoforest#highlight('RedItalic', s:palette.red, s:palette.none, 'italic')
  call neoforest#highlight('OrangeItalic', s:palette.orange, s:palette.none, 'italic')
  call neoforest#highlight('YellowItalic', s:palette.yellow, s:palette.none, 'italic')
  call neoforest#highlight('GreenItalic', s:palette.green, s:palette.none, 'italic')
  call neoforest#highlight('AquaItalic', s:palette.aqua, s:palette.none, 'italic')
  call neoforest#highlight('BlueItalic', s:palette.blue, s:palette.none, 'italic')
  call neoforest#highlight('PurpleItalic', s:palette.purple, s:palette.none, 'italic')
else
  call neoforest#highlight('RedItalic', s:palette.red, s:palette.none)
  call neoforest#highlight('OrangeItalic', s:palette.orange, s:palette.none)
  call neoforest#highlight('YellowItalic', s:palette.yellow, s:palette.none)
  call neoforest#highlight('GreenItalic', s:palette.green, s:palette.none)
  call neoforest#highlight('AquaItalic', s:palette.aqua, s:palette.none)
  call neoforest#highlight('BlueItalic', s:palette.blue, s:palette.none)
  call neoforest#highlight('PurpleItalic', s:palette.purple, s:palette.none)
endif
if s:configuration.transparent_background || s:configuration.sign_column_background ==# 'none'
  call neoforest#highlight('RedSign', s:palette.red, s:palette.none)
  call neoforest#highlight('OrangeSign', s:palette.orange, s:palette.none)
  call neoforest#highlight('YellowSign', s:palette.yellow, s:palette.none)
  call neoforest#highlight('GreenSign', s:palette.green, s:palette.none)
  call neoforest#highlight('AquaSign', s:palette.aqua, s:palette.none)
  call neoforest#highlight('BlueSign', s:palette.blue, s:palette.none)
  call neoforest#highlight('PurpleSign', s:palette.purple, s:palette.none)
else
  call neoforest#highlight('RedSign', s:palette.red, s:palette.bg1)
  call neoforest#highlight('OrangeSign', s:palette.orange, s:palette.bg1)
  call neoforest#highlight('YellowSign', s:palette.yellow, s:palette.bg1)
  call neoforest#highlight('GreenSign', s:palette.green, s:palette.bg1)
  call neoforest#highlight('AquaSign', s:palette.aqua, s:palette.bg1)
  call neoforest#highlight('BlueSign', s:palette.blue, s:palette.bg1)
  call neoforest#highlight('PurpleSign', s:palette.purple, s:palette.bg1)
endif
if s:configuration.diagnostic_text_highlight
  call neoforest#highlight('ErrorText', s:palette.none, s:palette.bg_red, 'undercurl', s:palette.red)
  call neoforest#highlight('WarningText', s:palette.none, s:palette.bg_yellow, 'undercurl', s:palette.yellow)
  call neoforest#highlight('InfoText', s:palette.none, s:palette.bg_blue, 'undercurl', s:palette.blue)
  call neoforest#highlight('HintText', s:palette.none, s:palette.bg_green, 'undercurl', s:palette.green)
else
  call neoforest#highlight('ErrorText', s:palette.none, s:palette.none, 'undercurl', s:palette.red)
  call neoforest#highlight('WarningText', s:palette.none, s:palette.none, 'undercurl', s:palette.yellow)
  call neoforest#highlight('InfoText', s:palette.none, s:palette.none, 'undercurl', s:palette.blue)
  call neoforest#highlight('HintText', s:palette.none, s:palette.none, 'undercurl', s:palette.green)
endif
if s:configuration.diagnostic_line_highlight
  call neoforest#highlight('ErrorLine', s:palette.none, s:palette.bg_red)
  call neoforest#highlight('WarningLine', s:palette.none, s:palette.bg_yellow)
  call neoforest#highlight('InfoLine', s:palette.none, s:palette.bg_blue)
  call neoforest#highlight('HintLine', s:palette.none, s:palette.bg_green)
else
...
elseif s:configuration.diagnostic_virtual_text ==# 'colored'
  ...
  call neoforest#highlight('VirtualTextWarning', s:palette.yellow, s:palette.bg_yellow)
  call neoforest#highlight('VirtualTextError', s:palette.red, s:palette.bg_red)
  call neoforest#highlight('VirtualTextInfo', s:palette.blue, s:palette.bg_blue)
  call neoforest#highlight('VirtualTextHint', s:palette.green, s:palette.bg_green)
endif
call neoforest#highlight('ErrorFloat', s:palette.red, s:palette.none)
call neoforest#highlight('WarningFloat', s:palette.yellow, s:palette.none)
call neoforest#highlight('InfoFloat', s:palette.blue, s:palette.none)
call neoforest#highlight('HintFloat', s:palette.green, s:palette.none)
if &diff
  call neoforest#highlight('CurrentWord', s:palette.bg0, s:palette.green)
elseif s:configuration.current_word ==# 'grey background'
  call neoforest#highlight('CurrentWord', s:palette.none, s:palette.bg2)
else
  call neoforest#highlight('CurrentWord', s:palette.none, s:palette.none, s:configuration.current_word)
endif
if s:configuration.inlay_hints_background ==# 'none'
  highlight! link InlayHints LineNr
else
  call neoforest#highlight('InlayHints', s:palette.grey1, s:palette.bg_dim)
endif
" Define a color for each LSP item kind to create highlights for nvim-cmp, aerial.nvim, nvim-navic and coc.nvim
let g:neoforest_lsp_kind_color = [
      \ ["Array", "Aqua"],
      \ ["Boolean", "Aqua"],
      \ ["Class", "Red"],
      \ ["Class", "Yellow"],
...
call neoforest#highlight('TSStrong', s:palette.none, s:palette.none, 'bold')
call neoforest#highlight('TSEmphasis', s:palette.none, s:palette.none, 'italic')
call neoforest#highlight('TSUnderline', s:palette.none, s:palette.none, 'underline')
call neoforest#highlight('TSNote', s:palette.bg0, s:palette.green, 'bold')
call neoforest#highlight('TSWarning', s:palette.bg0, s:palette.yellow, 'bold')
call neoforest#highlight('TSDanger', s:palette.bg0, s:palette.red, 'bold')
...
highlight! link TSFunctionCall ST2
...
call neoforest#highlight('TSURI', s:palette.blue, s:palette.none, 'underline')
...
if has('nvim-0.9')
  ...
  call neoforest#highlight('DiagnosticUnnecessary', s:palette.grey1, s:palette.none)
endif
...
" }}}
" neoclide/coc.nvim {{{
call neoforest#highlight('CocHoverRange', s:palette.none, s:palette.none, 'bold,underline')
call neoforest#highlight('CocSearch', s:palette.green, s:palette.none, 'bold')
call neoforest#highlight('CocPumSearch', s:palette.green, s:palette.none, 'bold')
call neoforest#highlight('CocMarkdownHeader', s:palette.orange, s:palette.none, 'bold')
call neoforest#highlight('CocMarkdownLink', s:palette.green, s:palette.none, 'underline')
...
if !exists('g:Lf_StlColorscheme')
  let g:Lf_StlColorscheme = 'neoforest'
endif
if !exists('g:Lf_PopupColorscheme')
  let g:Lf_PopupColorscheme = 'neoforest'
endif
call neoforest#highlight('Lf_hl_match', s:palette.green, s:palette.none, 'bold')
call neoforest#highlight('Lf_hl_match0', s:palette.green, s:palette.none, 'bold')
call neoforest#highlight('Lf_hl_match1', s:palette.aqua, s:palette.none, 'bold')
call neoforest#highlight('Lf_hl_match2', s:palette.blue, s:palette.none, 'bold')
call neoforest#highlight('Lf_hl_match3', s:palette.purple, s:palette.none, 'bold')
call neoforest#highlight('Lf_hl_match4', s:palette.orange, s:palette.none, 'bold')
call neoforest#highlight('Lf_hl_matchRefine', s:palette.red, s:palette.none, 'bold')
call neoforest#highlight('Lf_hl_popup_normalMode', s:palette.bg0, s:palette.red, 'bold')
call neoforest#highlight('Lf_hl_popup_inputMode', s:palette.bg0, s:palette.green, 'bold')
call neoforest#highlight('Lf_hl_popup_category', s:palette.fg, s:palette.bg4)
call neoforest#highlight('Lf_hl_popup_nameOnlyMode', s:palette.fg, s:palette.bg3)
call neoforest#highlight('Lf_hl_popup_fullPathMode', s:palette.fg, s:palette.bg3)
call neoforest#highlight('Lf_hl_popup_fuzzyMode', s:palette.fg, s:palette.bg3)
call neoforest#highlight('Lf_hl_popup_regexMode', s:palette.fg, s:palette.bg3)
call neoforest#highlight('Lf_hl_popup_lineInfo', s:palette.yellow, s:palette.bg4)
call neoforest#highlight('Lf_hl_popup_total', s:palette.bg0, s:palette.orange)
call neoforest#highlight('Lf_hl_popup_cursor', s:palette.bg0, s:palette.green)
...
" }}}
" liuchengxu/vim-clap {{{
call neoforest#highlight('ClapSelected', s:palette.red, s:palette.none, 'bold')
call neoforest#highlight('ClapCurrentSelection', s:palette.none, s:palette.bg1, 'bold')
call neoforest#highlight('ClapSpinner', s:palette.orange, s:palette.bg2, 'bold')
call neoforest#highlight('ClapBlines', s:palette.fg, s:palette.none)
call neoforest#highlight('ClapProviderId', s:palette.fg, s:palette.none, 'bold')
call neoforest#highlight('ClapMatches1', s:palette.red, s:palette.none, 'bold')
call neoforest#highlight('ClapMatches2', s:palette.orange, s:palette.none, 'bold')
call neoforest#highlight('ClapMatches3', s:palette.yellow, s:palette.none, 'bold')
call neoforest#highlight('ClapMatches4', s:palette.aqua, s:palette.none, 'bold')
call neoforest#highlight('ClapMatches5', s:palette.blue, s:palette.none, 'bold')
call neoforest#highlight('ClapMatches6', s:palette.purple, s:palette.none, 'bold')
call neoforest#highlight('ClapFuzzyMatches', s:palette.green, s:palette.none, 'bold')
call neoforest#highlight('ClapNoMatchesFound', s:palette.red, s:palette.none, 'bold')
...
" }}}
" Shougo/denite.nvim {{{
call neoforest#highlight('deniteMatchedChar', s:palette.green, s:palette.none, 'bold')
call neoforest#highlight('deniteMatchedRange', s:palette.green, s:palette.none, 'bold,underline')
call neoforest#highlight('deniteInput', s:palette.green, s:palette.bg3, 'bold')
call neoforest#highlight('deniteStatusLineNumber', s:palette.purple, s:palette.bg3)
...
call neoforest#highlight('MatchParenCur', s:palette.none, s:palette.none, 'bold')
call neoforest#highlight('MatchWord', s:palette.none, s:palette.none, 'underline')
call neoforest#highlight('MatchWordCur', s:palette.none, s:palette.none, 'underline')
" }}}
...
" }}}
" justinmk/vim-sneak {{{
call neoforest#highlight('SneakLabelMask', s:palette.orange, s:palette.orange)
...
call neoforest#highlight('VMCursor', s:palette.blue, s:palette.bg_blue)
...
if get(g:, 'indent_guides_auto_colors', 1) == 0
  call neoforest#highlight('IndentGuidesOdd', s:palette.bg0, s:palette.bg1)
  call neoforest#highlight('IndentGuidesEven', s:palette.bg0, s:palette.bg2)
endif
" }}}
...
call neoforest#highlight('QuickScopePrimary', s:palette.aqua, s:palette.none, 'underline')
call neoforest#highlight('QuickScopeSecondary', s:palette.blue, s:palette.none, 'underline')
" }}}
" APZelos/blamer.nvim {{{
...
if has('nvim')
" hrsh7th/nvim-cmp {{{
call neoforest#highlight('CmpItemAbbrMatch', s:palette.green, s:palette.none, 'bold')
call neoforest#highlight('CmpItemAbbrMatchFuzzy', s:palette.green, s:palette.none, 'bold')
...
call neoforest#highlight('TelescopeMatching', s:palette.green, s:palette.none, 'bold')
...
" }}}
" phaazon/hop.nvim {{{
call neoforest#highlight('HopNextKey', s:palette.orange, s:palette.none, 'bold')
call neoforest#highlight('HopNextKey1', s:palette.green, s:palette.none, 'bold')
highlight! link HopNextKey2 Green
highlight! link HopUnmatched Grey
" }}}
" lukas-reineke/indent-blankline.nvim {{{
call neoforest#highlight('IblScope', s:palette.grey1, s:palette.none, 'nocombine')
call neoforest#highlight('IblIndent', s:palette.bg4, s:palette.none, 'nocombine')
call neoforest#highlight('IndentBlanklineContextStart', s:palette.none, s:palette.bg2)
...
" }}}
" romgrk/barbar.nvim {{{
call neoforest#highlight('BufferCurrent', s:palette.fg, s:palette.bg0)
call neoforest#highlight('BufferCurrentIndex', s:palette.fg, s:palette.bg0)
call neoforest#highlight('BufferCurrentMod', s:palette.blue, s:palette.bg0)
call neoforest#highlight('BufferCurrentSign', s:palette.statusline1, s:palette.bg0)
call neoforest#highlight('BufferCurrentTarget', s:palette.red, s:palette.bg0, 'bold')
call neoforest#highlight('BufferVisible', s:palette.fg, s:palette.bg_dim)
call neoforest#highlight('BufferVisibleIndex', s:palette.fg, s:palette.bg_dim)
call neoforest#highlight('BufferVisibleMod', s:palette.blue, s:palette.bg_dim)
call neoforest#highlight('BufferVisibleSign', s:palette.statusline1, s:palette.bg_dim)
call neoforest#highlight('BufferVisibleTarget', s:palette.yellow, s:palette.bg_dim, 'bold')
call neoforest#highlight('BufferInactive', s:palette.grey1, s:palette.bg_dim)
call neoforest#highlight('BufferInactiveIndex', s:palette.grey1, s:palette.bg_dim)
call neoforest#highlight('BufferInactiveMod', s:palette.grey1, s:palette.bg_dim)
call neoforest#highlight('BufferInactiveSign', s:palette.grey0, s:palette.bg_dim)
call neoforest#highlight('BufferInactiveTarget', s:palette.yellow, s:palette.bg_dim, 'bold')
call neoforest#highlight('BufferTabpages', s:palette.grey1, s:palette.bg_dim, 'bold')
call neoforest#highlight('BufferTabpageFill', s:palette.bg_dim, s:palette.bg_dim)
" }}}
" rcarriga/nvim-notify {{{
call neoforest#highlight('NotifyBackground', s:palette.none, s:palette.bg0)
...
call neoforest#highlight('DapUIModifiedValue', s:palette.blue, s:palette.none, 'bold')
call neoforest#highlight('DapUIBreakpointsCurrentLine', s:palette.blue, s:palette.none, 'bold')
...
call neoforest#highlight('LspFloatWinBorder', s:palette.bg0, s:palette.bg0)
call neoforest#highlight('LspSagaDiagnosticHeader', s:palette.orange, s:palette.none, 'bold')
call neoforest#highlight('LspSagaCodeActionTitle', s:palette.purple, s:palette.none, 'bold')
call neoforest#highlight('DefinitionPreviewTitle', s:palette.blue, s:palette.none, 'bold')
...
" }}}
" b0o/incline.nvim {{{
call neoforest#highlight('InclineNormalNC', s:palette.grey1, s:palette.bg2)
" }}}
" echasnovski/mini.nvim {{{
call neoforest#highlight('MiniAnimateCursor', s:palette.none, s:palette.none, 'reverse,nocombine')
call neoforest#highlight('MiniFilesFile', s:palette.fg, s:palette.none)
if s:configuration.float_style ==# 'dim'
  call neoforest#highlight('MiniFilesTitleFocused', s:palette.green, s:palette.bg_dim, 'bold')
else
  call neoforest#highlight('MiniFilesTitleFocused', s:palette.green, s:palette.bg2, 'bold')
endif
call neoforest#highlight('MiniHipatternsFixme', s:palette.bg0, s:palette.red, 'bold')
call neoforest#highlight('MiniHipatternsHack', s:palette.bg0, s:palette.yellow, 'bold')
call neoforest#highlight('MiniHipatternsNote', s:palette.bg0, s:palette.blue, 'bold')
call neoforest#highlight('MiniHipatternsTodo', s:palette.bg0, s:palette.green, 'bold')
call neoforest#highlight('MiniIconsAzure', s:palette.blue, s:palette.none)
call neoforest#highlight('MiniIconsBlue', s:palette.blue, s:palette.none)
call neoforest#highlight('MiniIconsCyan', s:palette.aqua, s:palette.none)
call neoforest#highlight('MiniIconsGreen', s:palette.green, s:palette.none)
call neoforest#highlight('MiniIconsGrey', s:palette.grey2, s:palette.none)
call neoforest#highlight('MiniIconsOrange', s:palette.orange, s:palette.none)
call neoforest#highlight('MiniIconsPurple', s:palette.purple, s:palette.none)
call neoforest#highlight('MiniIconsRed', s:palette.red, s:palette.none)
call neoforest#highlight('MiniIconsYellow', s:palette.yellow, s:palette.none)
call neoforest#highlight('MiniIndentscopePrefix', s:palette.none, s:palette.none, 'nocombine')
call neoforest#highlight('MiniJump2dSpot', s:palette.orange, s:palette.none, 'bold,nocombine')
call neoforest#highlight('MiniJump2dSpotAhead', s:palette.aqua, s:palette.none, 'nocombine')
call neoforest#highlight('MiniJump2dSpotUnique', s:palette.yellow, s:palette.none, 'bold,nocombine')
if s:configuration.float_style ==# 'dim'
  call neoforest#highlight('MiniPickPrompt', s:palette.blue, s:palette.bg_dim)
else
  call neoforest#highlight('MiniPickPrompt', s:palette.blue, s:palette.bg2)
endif
call neoforest#highlight('MiniStarterCurrent', s:palette.none, s:palette.none, 'nocombine')
call neoforest#highlight('MiniStatuslineDevinfo', s:palette.grey1, s:palette.bg1)
call neoforest#highlight('MiniStatuslineFileinfo', s:palette.grey1, s:palette.bg1)
call neoforest#highlight('MiniStatuslineModeCommand', s:palette.bg0, s:palette.aqua, 'bold')
call neoforest#highlight('MiniStatuslineModeInsert', s:palette.bg0, s:palette.statusline2, 'bold')
call neoforest#highlight('MiniStatuslineModeNormal', s:palette.bg0, s:palette.statusline1, 'bold')
call neoforest#highlight('MiniStatuslineModeOther', s:palette.bg0, s:palette.purple, 'bold')
call neoforest#highlight('MiniStatuslineModeReplace', s:palette.bg0, s:palette.orange, 'bold')
call neoforest#highlight('MiniStatuslineModeVisual', s:palette.bg0, s:palette.statusline3, 'bold')
call neoforest#highlight('MiniTablineCurrent', s:palette.fg, s:palette.bg4)
call neoforest#highlight('MiniTablineHidden', s:palette.grey1, s:palette.bg2)
call neoforest#highlight('MiniTablineModifiedCurrent', s:palette.blue, s:palette.bg4)
call neoforest#highlight('MiniTablineModifiedHidden', s:palette.grey1, s:palette.bg2)
call neoforest#highlight('MiniTablineModifiedVisible', s:palette.blue, s:palette.bg2)
call neoforest#highlight('MiniTablineTabpagesection', s:palette.bg0, s:palette.statusline1, 'bold')
call neoforest#highlight('MiniTablineVisible', s:palette.fg, s:palette.bg2)
call neoforest#highlight('MiniTestEmphasis', s:palette.none, s:palette.none, 'bold')
call neoforest#highlight('MiniTestFail', s:palette.red, s:palette.none, 'bold')
call neoforest#highlight('MiniTestPass', s:palette.green, s:palette.none, 'bold')
call neoforest#highlight('MiniTrailspace', s:palette.none, s:palette.red)
...
call neoforest#highlight('LightspeedLabel', s:palette.red, s:palette.none, 'bold,underline')
call neoforest#highlight('LightspeedLabelDistant', s:palette.blue, s:palette.none, 'bold,underline')
call neoforest#highlight('LightspeedShortcut', s:palette.bg0, s:palette.red, 'bold')
call neoforest#highlight('LightspeedUnlabeledMatch', s:palette.fg, s:palette.none, 'bold')
call neoforest#highlight('LightspeedPendingOpArea', s:palette.bg0, s:palette.green)
...
" For example, the content between `syn_begin: sh/zsh` and `syn_end` will be placed in `after/syntax/sh/neoforest.vim` and `after/syntax/zsh/neoforest.vim`.
if neoforest#syn_exists(s:path) " If the syntax files exist.
  if s:configuration.better_performance
    if !neoforest#syn_newest(s:path, s:last_modified) " Regenerate if it's not up to date.
      call neoforest#syn_clean(s:path, 0)
      call neoforest#syn_gen(s:path, s:last_modified, 'update')
    endif
    finish
  else
    call neoforest#syn_clean(s:path, 1)
  endif
else
  if s:configuration.better_performance
    call neoforest#syn_gen(s:path, s:last_modified, 'generate')
    finish
  endif
endif
" syn_begin: vim-plug {{{
...
if !s:configuration.transparent_background
  call neoforest#highlight('NvimTreeNormal', s:palette.grey2, s:palette.bg_dim)
...
call neoforest#highlight('OctoBubblePurple', s:palette.bg0, s:palette.purple)
call neoforest#highlight('OctoBubbleYellow', s:palette.bg0, s:palette.yellow)
call neoforest#highlight('OctoBubbleBlue', s:palette.bg0, s:palette.blue)
call neoforest#highlight('OctoBubbleGrey', s:palette.bg0, s:palette.grey1)
...
if has('nvim-0.8')
  ...
  if !has('nvim-0.10')
    call neoforest#highlight('@markup.italic', s:palette.none, s:palette.none, 'italic')
    call neoforest#highlight('@markup.strikethrough', s:palette.none, s:palette.none, 'strikethrough')
  endif
endif
" }}}
" syn_end }}}
...
call neoforest#highlight('htmlBoldItalic', s:palette.none, s:palette.none, 'bold,italic')
call neoforest#highlight('htmlBoldUnderlineItalic', s:palette.none, s:palette.none, 'bold,underline,italic')
call neoforest#highlight('htmlUnderline', s:palette.none, s:palette.none, 'underline')
call neoforest#highlight('htmlUnderlineItalic', s:palette.none, s:palette.none, 'underline,italic')
call neoforest#highlight('htmlItalic', s:palette.none, s:palette.none, 'italic')
...
call neoforest#highlight('semshiUnresolved', s:palette.yellow, s:palette.none, 'undercurl')
...
" syn_end }}}
" syn_begin: vim {{{
call neoforest#highlight('vimCommentTitle', s:palette.grey1, s:palette.none, 'bold')
...
call neoforest#highlight('tomlTable', s:palette.orange, s:palette.none, 'bold')
...
" syn_end }}}
" syn_begin: dosini {{{
call neoforest#highlight('dosiniHeader', s:palette.red, s:palette.none, 'bold')
highlight! link dosiniLabel Yellow
highlight! link dosiniValue Green
highlight! link dosiniNumber Green
" syn_end }}}
" syn_begin: help {{{
call neoforest#highlight('helpNote', s:palette.purple, s:palette.none, 'bold')
call neoforest#highlight('helpHeadline', s:palette.red, s:palette.none, 'bold')
call neoforest#highlight('helpHeader', s:palette.orange, s:palette.none, 'bold')
call neoforest#highlight('helpURL', s:palette.green, s:palette.none, 'underline')
call neoforest#highlight('helpHyperTextEntry', s:palette.yellow, s:palette.none, 'bold')
...
call neoforest#highlight('NeotestExpandMarker', s:palette.bg5, s:palette.none)
...
call neoforest#highlight('MasonHeader', s:palette.bg0, s:palette.green, 'bold')
call neoforest#highlight('MasonHeaderSecondary', s:palette.bg0, s:palette.orange, 'bold')
highlight! link MasonHighlight Green
highlight! link MasonHighlightSecondary Yellow
call neoforest#highlight('MasonHighlightBlock', s:palette.bg0, s:palette.aqua)
call neoforest#highlight('MasonHighlightBlockBold', s:palette.bg0, s:palette.aqua, 'bold')
call neoforest#highlight('MasonHighlightBlockSecondary', s:palette.bg0, s:palette.yellow)
call neoforest#highlight('MasonHighlightBlockBoldSecondary', s:palette.bg0, s:palette.yellow, 'bold')
call neoforest#highlight('MasonMuted', s:palette.grey0, s:palette.none)
call neoforest#highlight('MasonMutedBlock', s:palette.bg0, s:palette.grey0)
" syn_end }}}
" }}}
